...
const Register = () => {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 flex justify-center items-center h-screen mt-[-40px]">
      <div className=" flex flex-col items-center justify-center py-6 mx-auto w-[90%]">
