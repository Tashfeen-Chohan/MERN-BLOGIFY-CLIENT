...
import { BsFill0CircleFill, BsFillInfoCircleFill } from "react-icons/bs";
...
const SimpleSidebar = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div
      ...
      } md:hidden bg-[#162B56] text-white w-64 h-screen transition-transform duration-100 ease-in-out`}
    >
